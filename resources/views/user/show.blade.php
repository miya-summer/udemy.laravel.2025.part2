...
{{--                            <x-thumbnail filename="{{$product->imageFirst->filename?? ''}}" type="products" />--}}
                        ...
                        <div class="md:w-1/2 ml-4">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <div class="flex sm:items-center text-gray-700">
                                ...
                                <button class="text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded">カートに入れる</button>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal__overlay" tabindex="-1" data-micromodal-close>
            <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-1-title">
                ...
                <footer class="modal__footer">
                    <button type="botton" class="modal__btn" data-micromodal-close aria-label="Close this dialog window">閉じる</button>
                </footer>
            </div>
        </div>
    </div>
