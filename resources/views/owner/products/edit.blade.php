                ...
                <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <div class="-m-2">
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                    ...
                                    <input type="hidden" id="current_quantity" name="current_quantity" value="{{ $quantity }}" required class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-yellow-500 focus:bg-white focus:ring-2 focus:ring-yellow-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            ...
                            <!-- コンポーネントに変数を渡す為に:images="$images"としてやる -->
                            ...
                            <x-select-image :images="$images" name="image5" /><!-- 最後だけおかしくなるので、5を作って、非表示で対応 -->
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative flex justify-around">
                    ...
                    <form method="post" id="delete_{{$product->id}}" action="{{ route('owner.products.destroy', ['product' => $product->id]) }}">
                        ...
                        <div class="p-2 w-full flex justify-around mt-32">
                            <a herf="#" data-id="{{ $product->id }}" onclick="deletePost(this)" class="text-white bg-red-400 border-0 py-2 px-4 focus:outline-none hover:bg-red-500 rounded">削除する</a>
                        </div>
                    </form>
                </div>
            </div>
